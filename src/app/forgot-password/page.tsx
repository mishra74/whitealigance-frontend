...
import { apiForgotPasswordOtp, apiResetPasswordOtp } from "@/lib/api";
      ...
      <div className="flex items-center justify-center p-14">
        <div className="w-full max-w-[360px]">
          ...
          {resetDone ? (
            ...
            <>
              <p className="mb-6 text-[0.9rem] text-warm-gray">
                We&apos;ve emailed a 6-digit code to <strong>{email}</strong>.
                Enter it below with your new password. The code expires in 10
                minutes.
              </p>
